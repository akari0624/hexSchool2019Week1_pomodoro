...
describe('TimeTextComponent test', () => {
  ...
  test('can render correct time text', async () => {
    ...
    const container = rtlRender(<TimeText wholeMinutes={25} passSeconds={30} />)
  ...
  test('can render "00:00" text',  () => {
    ...
    const container2 = rtlRender(<TimeText wholeMinutes={25} passSeconds={1500} />)
 ...
 test('if passSecond bigger than wholeMinutes, still render "00:00" text',  () => {
    ...
    const container3 = rtlRender(<TimeText wholeMinutes={25} passSeconds={1504} />)
